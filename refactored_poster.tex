...
\]
Таргет~--- \emph{нефильтрованное} будущее значение $y_t$.
...
\item \textbf{Гипотеза 1} (N3): медиана $F_4$ переводит SGD в сходящийся
      режим; линейные фильтры~--- нет.
\item \textbf{Гипотеза 2} (N2): для Adam/AdamW вейвлет $F_3$ ускоряет
      сходимость сильнее линейных фильтров.
\item \textbf{Гипотеза 3} (N4): ни один простой фильтр не снижает
      асимптотический уровень $\|\nabla f\|^2$.
\item \textbf{Гипотеза 4} (N1): фильтрация нейтральна, медиана чуть хуже
      среднего.
\end{itemize}
...
\textbf{N4:} отношение асимптотических уровней $F_0/F_k\approx1$ для всех
фильтров~--- ни один простой фильтр не работает (гипотеза~3). \textbf{N1:}
...
$\hat\alpha{<}1.9,\ \hat H{>}0.6$           & $F_4{/}F_2$, валид. & эвристика\\
\bottomrule
\end{tabular}
\end{center}
...
\item Все четыре гипотезы подтверждены на синтетике и реальных рядах.
